      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-3 p-3 overflow-hidden min-h-0">
        ...
        <div className="lg:col-span-5 h-full overflow-hidden">
          <QuestionPanel
            ...
            isSequentialTimedPhase={isSequentialTimedPhase}
            activeTimedQuestionId={activeTimedQuestion?.id}
          />
        </div>
        ...
        {currentQ.question_type === 'mcq' ? (
          <div className="lg:col-span-7 h-full overflow-hidden">
            <MCQPanel
              ...
              serverTime={examData?.server_time}
              isTimedMCQ={isTimedQuestion(currentQ)}
              hasMoreTimedMCQs={pendingTimedMCQs.filter((q: StudentQuestionView) => q.id !== currentQ.id).length > 0}
